...
import SMT.smt.domain.action
from SMT.smt.template import FormulaTemplate, EquTemplate
from SMT.smt.domain.utils.refiner import Refiner
...
# tmp_size = [ (1, 0, 1), (1,0,1),(1,0,1), (1,0,1),(1,0, 2), (1, 0, 2),(1,0,2), (1,0,2),(1, 0, 2),
#               (1,0,2), (1, 0, 2), (1, 0, 3),(1,0,3),(1,0,3), (2,0,1), (1, 1, 2),(3, 1,2), (3, 1,2), (2,1,2),(3,1,3),(3,2,1),(1,1,1),
#               (2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,6) ]


#
tmp_size=[(1,1,0),(1,1,0),(1,1,0),(1,2,0),(1,2,0),(1,2,0),(1,1,0),(1,1,0),(1,1,0),(1,1,0),(1,2,0),(2,1,1),
          (1,0,2),(2,0,2),(2,1,1),(3,1,1),(3,1,2),(3,2,1),(3,2,2)]
        ...
        while True:
            ...
            if s1.check() == sat:
                ...
                while flag == 0 :
                    ...
                    while (True):
                        print(example)
                        if (example in self.p_set or example in self.n_set):
                            example = list(example)
                            if (len(example) == 1):
                                example[0] = random.randint(1, 30)
                            elif (len(example) == 2):
                                example[0] = random.randint(1, 30)
                                example[1] = random.randint(10, 30)
                            elif (len(example) == 3):
                                example[0] = random.randint(1, 30)
                                example[1] = random.randint(1, 30)
                                example[2] = random.randint(10, 30)
                            example = tuple(example)
                        else:
                            break
                ...
                while flag == 0:
                    ...
                    while (True):
                        ...
                        if(example in self.p_set or example in self.n_set):
                            example = list(example)
                            if (len(example) == 1):
                                example[0] = random.randint(1,20)
                            elif (len(example) == 2):
                                example[0] = random.randint(1, 10)
                                example[1] = random.randint(1, 10)
                            elif (len(example) == 3):
                                example[0] = random.randint(1, 10)
                                example[1] = random.randint(1, 10)
                                example[2] = random.randint(1, 10)
                            example = tuple(example)
                        else:
                            break
