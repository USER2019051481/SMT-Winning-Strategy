...
from SMT.smt.generator import NormalGenerator
...
if __name__ == '__main__':
    ...
    pwd = "pddl/5.Chomp/5.2  L-shaped Chomp Game/L_shaped_chomp_game.pddl"
    domain = PDDLParser("pddl/5.Chomp/5.2  L-shaped Chomp Game/L_shaped_chomp_game.pddl")



    # # #
    # domain = PDDLParser("pddl/1.Sub/1.1 Take-away/Take-away-6.pddl") #N
    ...
    # domain = PDDLParser("pddl/4.Wythoff/4.1 Wythoff/Wythoff-v2-le-1.pddl")#策略有问题
    ...
    # domain = PDDLParser("pddl/2.Nim/2.18 Circular Nim/CircularNim(1,1).pddl")
    # domain = PDDLParser("pddl/2.Nim/2.8 l-Slow Nim/Two-piled-1-slow-nim.pddl")

    # domain = PDDLParser("pddl/5.Chomp/5.1 Chomp game/Two-rowed-Chomp_game.pddl")
    ...
    # formula = gen.generate_formula(0,0)
